...
import { View, Text, Button, StyleSheet, SafeAreaView, ScrollView, useColorScheme, Image} from 'react-native';
...
export default function Perfil({navigation}) {
 ...
 return (
    <View style={[styles.container, {flexDirection: "column", }]}>
        ...
        <Text style={{fontSize:23, paddingLeft:111,paddingTop:80}}>Your Name</Text>
        <Separator />
        ...
        <Button  disabled title = "      About     " onPress = { () => navigation.navigate('Home')}/>
        <Button disabled title = "     photos     " onPress = { () => navigation.navigate('Home')}/>
        <Button disabled title = "    friends      " onPress = { () => navigation.navigate('Home')}/>
